...
def main():
    ...
    space = {
        'con_out': hp.choice('con_out', [1, 50]),
        'con_kernel': hp.choice('con_kernel', [4, 8, 16]),
        'con_padding': 0,
        'lstm_hidden': hp.choice('lstm_hidden', [400, 600, 800]),
    ...
    # Run optimization
    best = fmin(fn=objective, space=space, algo=tpe.suggest, max_evals=54, trials=bayes_trials)
...
# With Re-Sampling
# The best parameters for FLAIR are {'con_kernel': 0, 'con_out': 1, 'linear_1_out': 0, 'lstm_hidden': 1}
# The best parameters for T1w are {'con_kernel': 0, 'con_out': 0, 'linear_1_out': 1, 'lstm_hidden': 1}
# The best parameters for T1wCE are {'con_kernel': 2, 'con_out': 1, 'linear_1_out': 1, 'lstm_hidden': 1}
# The best parameters for T2w are {'con_kernel': 1, 'con_out': 0, 'linear_1_out': 2, 'lstm_hidden': 0}
